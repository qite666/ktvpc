  ...
  .details-l {
    ...
    .l-fot {
      ...
      i {
        ...
        height: 10px;
        margin-right: 5px;
        background: url("../assets/img/arrow.png") 0 -19px;
      }
    }
  }
  .details-r {
          ...
          .levo-collect {
            ...
            .levo-coltwo {
              ...
              i {
                ...
                width: 18px;
                height: 19px;
                background: url("../assets/img/icon1.png") 0 -83px;
              }
              span {
                display: block;
                font-size: 14px;
